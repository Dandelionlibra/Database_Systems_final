...
------------------------------------------------
('Mona', 'Hydro', '法器', 810, 22, 51, 0, 0),
('Tartaglia', 'Hydro', '弓', 1020, 23, 63, 0, 0),
('Sangonomiya Kokomi', 'Hydro', '法器', 1049, 18, 51, 0, 0),
('Kamisato Ayato', 'Hydro', '單手劍', 1068, 23, 60, 0, 0),
('Yelan', 'Hydro', '弓', 1125, 19, 43, 0, 0),
('Nilou', 'Hydro', '單手劍', 1182, 18, 57, 0, 0),
('Furina', 'Hydro', '單手劍', 1192, 19, 54, 0, 0),
('Neuvillette', 'Hydro', '法器', 1144, 16, 45, 0, 0),
...
('Kaedehara Kazuha', 'Anemo', '單手劍', 1039, 23, 63, 0, 0.0),
...
('Kaveh', 'Dendro', '雙手劍', 1003, 20, 63, 0, 0.0),
('Kirara', 'Cryo', '單手劍', 1021, 19, 46, 0, 0.0);

UPDATE characters
SET c_crit_damage = 0.5, c_crit_rate = 0.2 ;
